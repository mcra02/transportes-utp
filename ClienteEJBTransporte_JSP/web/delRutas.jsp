...
Rodrigo --%> <%@page import="Entidad.Provincia"%> <%@page
import="Entidad.Departamento"%> <%@page import="Entidad.Rutas"%> <%@page
import="java.util.List"%> <%@include file="templates/header.jsp" %>
  ...
  <form action="RutasDelete" method="post">
    ...
    <div class="form-row">
      <div class="col-md-6 mb-3">
        ...
        >
          <option
            ><%= ruta.getProvinciaByPartida().getProvinciaNombre() %></option
          >
        </select>
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="col-md-6 mb-3">
        ...
        >
          <option
            ><%= ruta.getProvinciaByDestino().getProvinciaNombre() %></option
          >
        </select>
      </div>
    </div>
